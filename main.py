...
def main():
    ...
    header = Frame(root,bg='turquoise2')
    ...
    photo3=PhotoImage(file=r"logo3.png")
    canvas1.create_image(100,88,image=photo3)
    ...
    canvas3=Canvas(content, width=1350, height=600,bg='turquoise2')
    canvas3.place(x=0,y=0)
    photo=PhotoImage(file=r"rutuja.png")
    canvas3.create_image(1350,70,image=photo)
    l1=Label(canvas3,text="Training and Placement cell",bg="#c6c6d0",fg="brown",font=("Times new roman",20,"bold"),width=20).place(x=7,y=55)
    training="""The Placement Cell plays a crucial role in locating job opportunities for Under Graduates and Post Graduates passing out from the college by keeping in touch """
    training1="""with reputed firms and industrial establishments. The Placement Cell operates round the year to facilitate contacts between companies and graduates. """
    training2="""The number of students placed through the campus interviews is continuously rising. On many reputed industries visit the institute to conduct interviews. """ 
    training4="""We have been successful in maintaining our high placement statistics over the years and the fact that our students bear the recession record breaking placements """
    training5="""itself is a testimony to our quality. Our ingenious alumnae have set new standards in the corporate world through their blues with estimable contributions"""
    training6="""and it is my firm conviction that we will continue that legacy inthe years to come."""
    training7="""The Placement Cell organizes career guidance programmes for all the students starting from first year. The cell arranges training programmes like Mock Inter- """
    training8="""views, Group Discussions, Communication Skills Workshop etc and it also organizes Public Sector. Exam Training for students who are interested to join """
    training9=""" Government Sectors. It also invites HR Managers from different industries to conduct training programmes for final year students."""
    
    l2=Label(content,text=training,bg="#c6c6d0",font=("Times new roman",16)).place(x=10,y=110)
    l2=Label(content,text=training1,bg="#c6c6d0",font=("Times new roman",16)).place(x=10,y=135)
    l2=Label(content,text=training2,bg="#c6c6d0",font=("Times new roman",16)).place(x=10,y=160)
    l2=Label(content,text=training4,bg="#c6c6d0",font=("Times new roman",16)).place(x=10,y=200)
    l2=Label(content,text=training5,bg="#c6c6d0",font=("Times new roman",16)).place(x=10,y=225)
    l2=Label(content,text=training6,bg="#c6c6d0",font=("Times new roman",16)).place(x=10,y=250)
    l2=Label(content,text=training7,bg="#c6c6d0",font=("Times new roman",16)).place(x=10,y=290)
    l2=Label(content,text=training8,bg="#c6c6d0",font=("Times new roman",16)).place(x=10,y=315)
    l2=Label(content,text=training9,bg="#c6c6d0",font=("Times new roman",16)).place(x=10,y=340) 
    b6=Button(content,text="HOME",activebackground="turquoise2",activeforeground="black",font=("Georgia",14),width=17,bg="white",padx=20,pady=0,command=HOME).place(x=380,y=6)
    b6=Button(content,text="CONTACT US",activebackground="turquoise2",activeforeground="black",font=("Georgia",14),padx=20,pady=0,width=17,bg="white",command=CONTACT_US).place(x=680,y=6)
    mainloop()   
#for student section
def student_section():
...
def CONTACT_US():
    ...
    canvassss1=Canvas(root,width=1350,height=700,bg='turquoise3')
    canvassss1.place(x=0,y=0)
    canvassss1.create_rectangle(5,5,1350,700,width=5,outline="black")
    
    name=StringVar(root)
    canvass111 = Canvas(canvassss1,width=650, height=400)
    canvass111.place(x=340,y=100)
    canvass111.create_rectangle(5,5,650,400,width=5,outline="black",fill="white")
    
    l1=Label(canvass111,text="CONTACT US ",font=("Georgia",23,"bold"),bg="white")
    l1.place(x=240,y=10)
    canvass111.create_line(0,60,650,60,width=2)

    img12=PhotoImage(file=r"businessman.PNG")
    a=Label(canvass111,image=img12,bg="white").place(x=160,y=10)

    ll2=Label(canvass111,text="NAME",font=("Georgia",16,"bold"),bg="white")
    ll2.place(x=70,y=80)
    i1=PhotoImage(file=r"user.PNG")
    a=Label(canvass111,image=i1,bg="white").place(x=20,y=70)
                                         
    l2=Button(canvass111,text="Rutuja R. Mindhe",bg="white",font=("Georgia",13,"bold"))
    l2.place(x=20,y=130)
    l2=Button(canvass111,text="Prachi A. Mishra ",bg="white",font=("Georgia",13,"bold"))
    l2.place(x=20,y=190)
    l2=Button(canvass111,text="Deepika R. Sahu ",bg="white",font=("Georgia",13,"bold"))
    l2.place(x=20,y=260)
    ll2=Label(canvass111,text="Phone NO.",font=("Georgia",16,"bold"),bg="white")
    ll2.place(x=230,y=80)
    i3=PhotoImage(file=r"whatsapp.PNG")
    a=Label(canvass111,image=i3,bg="white").place(x=180,y=70)
    l2=Button(canvass111,text="8668525661",bg="white",font=("Georgia",13,"bold"))
    l2.place(x=220,y=130)
    l2=Button(canvass111,text="9892725052",bg="white",font=("Georgia",13,"bold"))
    l2.place(x=220,y=190)
    l2=Button(canvass111,text="9920449051",bg="white",font=("Georgia",13,"bold"))
    l2.place(x=220,y=260)
    ll2=Label(canvass111,text="Gmail",font=("Georgia",16,"bold"),bg="white")
    ll2.place(x=480,y=80)
    i2=PhotoImage(file=r"Gmail.PNG")
    a=Label(canvass111,image=i2,bg="white").place(x=420,y=70)
    l2=Button(canvass111,text="rutujamindhe@gmail.com",bg="white",font=("Georgia",13,"bold"))
    l2.place(x=370,y=130)
    l2=Button(canvass111,text="prachimishra778@gmail.com",bg="white",font=("Georgia",13,"bold"))
    l2.place(x=370,y=190)
    l2=Button(canvass111,text="deepikas8149@gmail.com",bg="white",font=("Georgia",13,"bold"))
    l2.place(x=370,y=260)
    btn=Button(canvass111,text="Back",font=("Georgia",11,"bold"),bg="white",padx=30,pady=3,border=3,command=main).place(x=230,y=320)   
    mainloop()
#for home page
def HOME():
    root.geometry('1350x700')
    ...
    mainloop()
#for button in student section(register a student)
def signup():
    root.geometry("1350x700")
    root.resizable(0,0)
    ...
    def table():       
        ...
        f.execute("""Create table if not exists 'signup'(Name text,Enroll_no TEXT,dob TEXT,Gender TEXT,Mobile_no INT,
                        ...
                        s2 TEXT,s2m INT,s3 TEXT,s3m INT,s4 TEXT,s4m INT,s5 TEXT,s5m INT,Project_details TEXT,pas TEXT)""")
        f.execute("insert into 'signup' values('{}','{}','{}','{}',{},{},'{}','{}','{}',{},{},{},{},{},{},{},{},'{}',{},'{}',{},'{}',{},'{}',{},'{}',{},'{}','{}')".format(n1.get(),en.get(),dob.get(),g.get(),mob.get(),mob1.get(),mail.get(),add.get(),dep.get(),yr.get(),fy.get(),sy.get(),ty.get(),sc.get(),scy.get(),hsc.get(),hscy.get(),s1.get(),s1m.get(),s2.get(),s2m.get(),s3.get(),s3m.get(),s4.get(),s4m.get(),s5.get(),s5m.get(),p.get(),pas.get()))
        db.commit()
        db.close()
    ...
    def form2():
        ...
        if  dep.get()=="Information Technology":
            ...
            l1=["python","java","cpp","c","html",".net","android studio"]
        elif  dep.get()=="Civil Engineering":
            l1=["engineering drawing","physics","maths","chemistry"]
        ...
        #password
        Label21=Label(canvas2,text="Password",bg="white",font=("Bold",12))
        Label21.place(x=40,y=580)
        e18=Entry(canvas2,textvariable=pas,font=(12),width=30)
        e18.place(x=160,y=580)

        pas1=StringVar()
        Label22=Label(canvas2,text="Confirm Password",bg="white",font=("Bold",12))
        Label22.place(x=40,y=620)
        e19=Entry(canvas2,textvariable=pas1,show="*",font=(12),width=30)
        e19.place(x=180,y=620)
        def table2():
            sc1=str(sc.get())
            ...
            p.get()
            if pas.get()!=pas1.get():
                Label2=Label(canvas2,text="Password is not same!.",bg="white",fg="red",font=("Bold",12))
                Label2.place(x=500,y=580)
            else:
                pas.get() 
                table()
                form2
       
        b4=Button(canvas2,text="Back",command=form1,bg="white",padx=40,pady=4,border=3).place(x=160,y=640)
        b2=Button(canvas2,text="Submit",command=table2,bg="white",padx=40,pady=4,border=3).place(x=290,y=640)
...
def login_student():    
    ...
    def signup_view(en1):
        ...
        def form2():
            ...
            e17.place(x=160,y=540)
            b=Button(canvas2,text="Back",command=student_section,bg="white",padx=40,pady=4,border=3).place(x=160,y=650)               
        form1()
        mainloop()
    def student_login():
        def check():
